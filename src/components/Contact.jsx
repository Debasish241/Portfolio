...
const Contact = () => {
  ...
  const handleSubmit =(e)=>{
    ...
    emailjs.send(
      ...
      to_email:'debasishdebnath2205@gmail.com',
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      <motion.div variants={slideIn('left','tween',0.2,1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          <label className="flex flex-col gap-8"><span className="text-white font-medium mb-4">Your Name</span>
          ...
          <label className="flex flex-col gap-8"><span className="text-white font-medium mb-4">Your Email</span>
          ...
          <label className="flex flex-col gap-8"><span className="text-white font-medium mb-4">Your Message</span>
          ...
          <button type="submit" className="bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-pimary rounded-xl">
